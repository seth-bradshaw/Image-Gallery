...
export default function ModalWrapper({ children, title, handleClose }: PropsWithChildren<Props>) {
  return (
    <div className="w-full h-screen z-40 bg-slate-300/25 block top-0 fixed shadow">
      <div className="h-full w-full flex items-center justify-center">
        <div className="w-full h-screen sm:w-96 sm:h-96 md:h-[480px] md:w-[480px] bg-white flex flex-col gap-2 rounded">
